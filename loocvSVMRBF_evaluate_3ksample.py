...
#Load Data take 3000 sample
print("Memuat data dan model...")
X = np.load("hog_features.npy")
y = np.load("labels.npy")
print("Data asli:", X.shape, "| Label:", y.shape)

# Sampling 3000 data secara stratified
X_small, _, y_small, _ = train_test_split(
    X, y, train_size=3000, stratify=y, random_state=42
)
...
# Checkpoint Setup
SAVE_FILE = "loocv_partial_3000_RBF.pkl"
SAVE_INTERVAL = 4  # Simpan tiap 50 iterasi
partial_results = []
...
# 5. Evaluasi LOOCV 
print("Evaluasi LOOCV (3000 sample - RBF kernel)...")
start = time.time()
...
print("\nSemua data (3000 sample - RBF kernel) selesai dievaluasi.")
...
print("\n=== HASIL EVALUASI LOOCV (3000 Sample, RBF Kernel) ===")
...
plt.title("Confusion Matrix (LOOCV - 3000 Sample - SVM RBF)")
plt.xlabel("Predicted Label")
plt.ylabel("True Label")
plt.savefig("confusion_matrix_loocv_3k_RBF.png", dpi=300, bbox_inches='tight')
plt.show()
print("\nConfusion matrix disimpan sebagai 'confusion_matrix_loocv_3k_RBF.png'")
#All report
